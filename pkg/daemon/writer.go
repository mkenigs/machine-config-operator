...
type NodeWriter interface {
	...
	SetLayeredDone(client corev1client.NodeInterface, lister corev1lister.NodeLister, node string, image string) error
...
func (nw *clusterNodeWriter) SetLayeredDone(client corev1client.NodeInterface, lister corev1lister.NodeLister, node string, image string) error {
	annos := map[string]string{
